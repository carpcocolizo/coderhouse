...
function primerArticulo(art) {
    ...
    nuevoarticulo.innerHTML = `Usted va a tener que vender el producto ${art.nombre} por el valor de $${art.calculoComision()} para poder obtener $${art.aobtener}
    ya que la plataforma le cobra una comision de ${art.comision}% y tiene un envio de $${art.envio}`
